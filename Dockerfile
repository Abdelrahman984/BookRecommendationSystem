...
COPY ["CleanArchitecture.DataAccess/CleanArchitecture.DataAccess.csproj", "CleanArchitecture.DataAccess/"]
COPY ["CleanArchitecture.Utilities/CleanArchitecture.Utilities.csproj", "CleanArchitecture.Utilities/"]
COPY ["CleanArchitecture.Infrastructure/CleanArchitecture.Infrastructure.csproj", "CleanArchitecture.Infrastructure/"]
COPY ["CleanArchitecture.Services/CleanArchitecture.Services.csproj", "CleanArchitecture.Services/"]
